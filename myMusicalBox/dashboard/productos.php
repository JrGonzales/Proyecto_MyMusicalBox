...
<div class="container-fluid">
  <div class="row">
    ...
    <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">  
        <h3 align="center" style="margin-top: 20px">Listado de Productos</h3>
        <table class="table">
            <tr>
                <th>Codigo</th>
                <th>Descripcion</th>
            ...
            <tr>
                ...
                <td><img src="../Img/<?php echo $row[6] ?>" width="30" height="30"</td>
                <td>
                    || <a href="formulario.php?op=2&cod=<?php echo $row[0]; ?>" class="btn btn-success" style="color:white;">Editar</a> ||
                    <a href="mantenimientos.php?op=3&cod=<?php echo $row[0]; ?>" class="btn btn-danger" style="color:white;">Eliminar</a> ||
                </td>
            </tr>
            <?php          
            }
